...
export function SiteFooter() {
  return (
    <footer className="bg-background border-t">
      <div className="mx-auto flex w-full max-w-7xl flex-col flex-wrap gap-8 px-6 py-24 lg:flex-row lg:flex-nowrap lg:gap-4 lg:px-16">
        ...
        <div className="grid w-full basis-5/6 grid-cols-2 gap-x-4 gap-y-8 text-sm lg:grid-cols-3 lg:gap-y-4 xl:grid-cols-4">
